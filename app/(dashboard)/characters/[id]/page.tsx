    ...
    <div className="mx-auto max-w-[82rem]">
      ...
      <section className="mt-4 grid gap-5 border-b border-zinc-800/80 pb-6 md:grid-cols-[236px_minmax(0,1fr)] lg:grid-cols-[260px_minmax(0,1fr)]">
        <aside className="mx-auto w-full max-w-[260px] md:mx-0">
          ...
          <div className="mt-3 flex flex-wrap gap-1.5"><StatusBadge status={character.status} />{character.sources.map((source) => <SourceBadge key={`${source.platform}-${source.sourceUrl}`} platform={source.platform} variant="compact" />)}</div>
        </aside>

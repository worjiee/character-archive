      ...
      <header className="mt-3 border-b border-zinc-800/80 pb-5">
        <div className="flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
          <div className="min-w-0">
            <div className="flex flex-wrap items-center gap-2"><SourceBadge platform={profile.identity.platform} /><span className="text-[10px] font-medium uppercase tracking-[0.12em] text-zinc-600">Source-scoped creator</span></div>
